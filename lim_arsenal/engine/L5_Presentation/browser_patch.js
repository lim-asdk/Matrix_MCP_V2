...
(function() {
    ...
    // If desktop force is set, we skip browser mode immediately
    if (window.__ASDK_DESKTOP_FORCE__ || window.pywebview) {
        return;
    }

    // Delay initialization to give pywebview a chance to inject
    setTimeout(() => {
